...
import {
  ...
  PublicDecryptMultipleValues__factory,
...
async function deployFixture() {
  ...
  const highestDiceRoll =
    (await factory.deploy()) as PublicDecryptMultipleValues;
...
describe("PublicDecryptMultipleValues", function () {
  ...
  it("decryption should succeed", async function () {
    console.log(``);
    console.log(
      `🎲 PublicDecryptMultipleValues Game contract address: ${contractAddress}`
    );
