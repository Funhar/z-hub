...
import {
  ...
  PublicDecryptSingleValue__factory,
...
async function deployFixture() {
  ...
  const headsOrTails = (await factory.deploy()) as PublicDecryptSingleValue;
...
describe("PublicDecryptSingleValue", function () {
  ...
  it("decryption should succeed", async function () {
    console.log(``);
    console.log(
      `🎲 PublicDecryptSingleValue Game contract address: ${contractAddress}`
    );
